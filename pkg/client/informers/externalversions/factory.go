...
import (
	...
	fdu "github.com/atolab/fog05-manager/pkg/client/informers/externalversions/fdu"
...
func (f *sharedInformerFactory) Fog05() fdu.Interface {
	return fdu.New(f, f.namespace, f.tweakListOptions)
}
